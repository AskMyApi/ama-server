...
public class Oauth2UserWrapper {
    ...
    private Oauth2UserWrapper(OAuth2User oAuth2User) {
        this.oAuth2User = oAuth2User;
    }

    public static Oauth2UserWrapper from(OAuth2User oAuth2User) {
        return new Oauth2UserWrapper(oAuth2User);
    }
    ...
    public LoadOrCreateOauthCommand toCommand() {
        return new LoadOrCreateOauthCommand(
                oAuth2User.getName(),
                strategy.getEmail(oAuth2User.getAttributes()),
